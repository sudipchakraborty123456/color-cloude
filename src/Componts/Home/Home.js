                ...
                <Carousel className="carousel" showThumbs={false} stopOnHover={true} autoPlay={true} interval={3000} infiniteLoop={true} >
                    {thumb.map((item, index) => {
                        return (<div key={index}>
                            <img src={require("./Img/" + item)} key={index} id={index} alt="Opps Sorry!" style={{ height: "450px" }} />
                        </div>);
                    })
                    }
                </Carousel>
                    ...
                    <div className="row justify-content-center" style={{ backgroundColor: "#f2f2f2" }} >
                        ...
                        <div className="col-12 col-sm-12 col-md-6 col-lg-6 mb-5">
                            ...
                            <div className="  row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >Does Creation Multimedia Provide Job Placement Assistance?</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >Why to Join Creation Multimedia only?</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >What is the fee Structure ?</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >What Are the modes of Payments ?</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >Do we provide Internship ?</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >What Certificate do we provide ?</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-11">
                                    <h5 className="d-inline" >What are the courses Duration ?</h5>
